            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3">
                    <div class="flex gap-1">
                        <a href="{{ route('admin.departamentos.edit', $d) }}" class="p-1.5 text-blue-600 hover:bg-blue-50 rounded"><i class="fa-solid fa-pen-to-square"></i></a>
                        <form method="POST" action="{{ route('admin.departamentos.destroy', $d) }}" onsubmit="return confirm('Remover?')">
                            @csrf @method('DELETE')
