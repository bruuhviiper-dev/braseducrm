    ...
    <table class="w-full text-sm text-left">
        ...
        <tbody class="divide-y">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3">
                    <x-kebab :edit="route('geral.campanhas-indicacao.edit', $c)" :delete="route('geral.campanhas-indicacao.destroy', $c)" />
                </td>
            </tr>
            @empty
            <tr><td colspan="6" class="px-4 py-8 text-center text-gray-400">Nenhuma campanha cadastrada.</td></tr>
            @endforelse
        </tbody>
    </table>
