...
<x-data-table title="Modelos de Documento" codigo="9" :createRoute="route('geral.modelos-documento.create')">
    <table class="w-full text-sm text-left">
        ...
        <tbody class="divide-y">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3">
                    <div class="flex gap-1">
                        <a href="{{ route('geral.modelos-documento.edit', $m) }}" class="p-1.5 text-blue-600 hover:bg-blue-50 rounded"><i class="fa-solid fa-pen-to-square"></i></a>
                        <form method="POST" action="{{ route('geral.modelos-documento.destroy', $m) }}" onsubmit="return confirm('Remover?')">
                            @csrf @method('DELETE')
            ...
            @empty
            <tr><td colspan="4" class="px-4 py-8 text-center text-gray-400">Nenhum modelo cadastrado.</td></tr>
            @endforelse
        </tbody>
    </table>
