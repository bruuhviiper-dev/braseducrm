                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-4 py-3 text-center">
                        <div class="flex items-center justify-center gap-1">
                            <a href="{{ route('crm.interessados.edit', $interessado) }}" class="p-1.5 text-gray-400 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition" title="Editar">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                            <form method="POST" action="{{ route('crm.interessados.destroy', $interessado) }}" class="inline" onsubmit="return confirm('Tem certeza que deseja remover este interessado?')">
                                @csrf
                                @method('DELETE')
