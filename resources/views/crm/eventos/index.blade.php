            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3">
                    <div class="flex gap-1">
                        <a href="{{ route('crm.eventos.edit', $e) }}" class="p-1.5 text-blue-600 hover:bg-blue-50 rounded"><i class="fa-solid fa-pen-to-square"></i></a>
                        <form method="POST" action="{{ route('crm.eventos.destroy', $e) }}" onsubmit="return confirm('Remover?')">
                            @csrf @method('DELETE')
