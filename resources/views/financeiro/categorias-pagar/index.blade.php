            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3">
                    <div class="flex gap-1">
                        <a href="{{ route('financeiro.categorias-pagar.edit', $c) }}" class="p-1.5 text-blue-600 hover:bg-blue-50 rounded"><i class="fa-solid fa-pen-to-square"></i></a>
                        <form method="POST" action="{{ route('financeiro.categorias-pagar.destroy', $c) }}" onsubmit="return confirm('Remover?')">
                            @csrf @method('DELETE')
