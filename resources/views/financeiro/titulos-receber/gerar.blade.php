...
@section('content')
<div class="w-full" x-data="{ gerarPara: '{{ $gerarPara ?? 'matricula' }}' }">
    <div class="bg-white">
        ...
        <form method="POST" action="{{ route('financeiro.titulos-receber.gerar') }}" class="p-6 space-y-4"
            ...
            <div class="flex justify-end gap-3 pt-2 border-t">
                ...
                <button type="submit" class="px-8 py-3 bg-cyan-500 hover:bg-cyan-400 text-white rounded-full text-sm font-bold shadow-lg shadow-cyan-500/30"><i class="fa-solid fa-check mr-1"></i> Gerar Títulos</button>
            </div>
        </form>
        @else
