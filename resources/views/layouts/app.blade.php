            ...
            <nav class="flex-1 overflow-y-auto scrollbar-thin py-1">
                ...
                <div x-data="{ open: activeModule === 'comunicacao' }">
                    ...
                    <div x-show="open && navOpen" x-cloak x-collapse class="bg-slate-800/50">
                        ...
                        <a href="{{ route('comunicacao.mensagens.aviso-pagamento') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700 {{ request()->routeIs('comunicacao.mensagens.aviso-pagamento') ? 'text-primary-400' : '' }}"><span class="text-slate-600 mr-1">234</span> Aviso de Pagamento</a>
                        <a href="{{ route('comunicacao.mensagens.interessados') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700 {{ request()->routeIs('comunicacao.mensagens.interessados') ? 'text-primary-400' : '' }}"><span class="text-slate-600 mr-1">62</span> Mensagens para Interessados CRM</a>
                        <p class="px-4 py-1.5 text-[10px] uppercase tracking-wider text-slate-500 font-semibold mt-1">Configuracao</p>
                        ...
                        <a href="{{ route('comunicacao.saldo-sms') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700 {{ request()->routeIs('comunicacao.saldo-sms') ? 'text-primary-400' : '' }}"><span class="text-slate-600 mr-1">89</span> Consulta de Saldo SMS</a>
                        <a href="{{ route('cadastros.index', 'numeros-whatsapp') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700"><span class="text-slate-600 mr-1">247</span> Numeros Whatsapp</a>
                        <a href="{{ route('comunicacao.notificacoes.index') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700 {{ request()->routeIs('comunicacao.notificacoes.*') ? 'text-primary-400' : '' }}"><span class="text-slate-600 mr-1">260</span> Central de Notificacao do Aluno</a>
                    </div>
                </div>
                ...
                <div x-data="{ open: activeModule === 'crm' }">
                    ...
                    <div x-show="open && navOpen" x-cloak x-collapse class="bg-slate-800/50">
                        ...
                        <a href="{{ route('cadastros.index', 'acoes-automaticas') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700"><span class="text-slate-600 mr-1">256</span> Acao Automatica (CRM)</a>
                        ...
                        <a href="{{ route('crm.propostas.index') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700 {{ request()->routeIs('crm.propostas.*') ? 'text-primary-400' : '' }}"><span class="text-slate-600 mr-1">201</span> Emissao de Propostas (CRM)</a>
                        <a href="{{ route('crm.exportacao.index') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700 {{ request()->routeIs('crm.exportacao.*') ? 'text-primary-400' : '' }}"><span class="text-slate-600 mr-1">159</span> Exportacao de Oportunidades</a>
                ...
                <div x-data="{ open: activeModule === 'ead' }">
                    ...
                    <div x-show="open && navOpen" x-cloak x-collapse class="bg-slate-800/50">
                        ...
                        <a href="{{ route('ead.sub-agrupadores.index') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700 {{ request()->routeIs('ead.sub-agrupadores.*') ? 'text-primary-400' : '' }}"><span class="text-slate-600 mr-1">266</span> Cadastro de Sub Agrupador (EAD)</a>
                        ...
                        <a href="{{ Route::has('ead.questoes.index') ? route('ead.questoes.index') : '#' }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700 {{ request()->routeIs('ead.questoes.*') ? 'text-primary-400' : '' }}"><span class="text-slate-600 mr-1">238</span> Cadastro de Questoes Avulsas</a>
                        ...
                        <a href="{{ route('ead.geradores.index') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700 {{ request()->routeIs('ead.geradores.*') ? 'text-primary-400' : '' }}"><span class="text-slate-600 mr-1">241</span> Gerador de Avaliacoes</a>
                        <a href="{{ Route::has('ead.videos.index') ? route('ead.videos.index') : '#' }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700 {{ request()->routeIs('ead.videos.*') ? 'text-primary-400' : '' }}"><span class="text-slate-600 mr-1">301</span> Cadastro de Videos</a>
                        <a href="{{ route('ead.foruns.index') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700 {{ request()->routeIs('ead.foruns.*') ? 'text-primary-400' : '' }}"><span class="text-slate-600 mr-1">306</span> Foruns EAD</a>
                        ...
                        <a href="{{ route('ead.emissoes.index') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700 {{ request()->routeIs('ead.emissoes.*') ? 'text-primary-400' : '' }}"><span class="text-slate-600 mr-1">174</span> Emissao de Alunos Matriculados EAD</a>
                        <a href="{{ route('ead.emissoes.index') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700 {{ request()->routeIs('ead.emissoes.*') ? 'text-primary-400' : '' }}"><span class="text-slate-600 mr-1">219</span> Emissao de notas alunos (EAD)</a>
                    </div>
                </div>
                ...
                <div x-data="{ open: activeModule === 'financeiro' }">
                    ...
                    <div x-show="open && navOpen" x-cloak x-collapse class="bg-slate-800/50">
                        ...
                        <a href="{{ route('financeiro.nfse.index') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700 {{ request()->routeIs('financeiro.nfse.*') ? 'text-primary-400' : '' }}"><span class="text-slate-600 mr-1">227</span> Configuracoes de NFS-e</a>
                ...
                <div x-data="{ open: activeModule === 'geral' || activeModule === 'pessoas' || activeModule === 'atendimentos' }">
                    ...
                    <div x-show="open && navOpen" x-cloak x-collapse class="bg-slate-800/50">
                        ...
                        <a href="{{ route('cadastros.index', 'atributos-adicionais') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700"><span class="text-slate-600 mr-1">97</span> Cadastro de Atributos Adicionais</a>
                        <a href="{{ route('geral.consultas.index') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700 {{ request()->routeIs('geral.consultas.*') ? 'text-primary-400' : '' }}"><span class="text-slate-600 mr-1">221</span> Consulta Personalizada</a>
                        <p class="px-4 py-1.5 text-[10px] uppercase tracking-wider text-slate-500 font-semibold mt-1">Configuracoes de Emissoes</p>
                        <a href="{{ route('cadastros.index', 'assinaturas') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700"><span class="text-slate-600 mr-1">6</span> Cadastro de Assinatura</a>
                        <a href="{{ route('geral.modelos-documento.index') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700 {{ request()->routeIs('geral.modelos-documento.*') ? 'text-primary-400' : '' }}"><span class="text-slate-600 mr-1">9</span> Cadastro de Modelo de Documentos</a>
                        <a href="{{ route('cadastros.index', 'cabecalhos') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700"><span class="text-slate-600 mr-1">48</span> Modelos de Cabecalho</a>
                        <p class="px-4 py-1.5 text-[10px] uppercase tracking-wider text-slate-500 font-semibold mt-1">Indicacao</p>
                        <a href="{{ route('geral.campanhas-indicacao.index') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700 {{ request()->routeIs('geral.campanhas-indicacao.*') ? 'text-primary-400' : '' }}"><span class="text-slate-600 mr-1">225</span> Campanha de Indicacao</a>
                        <a href="{{ route('geral.indicacoes.index') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700 {{ request()->routeIs('geral.indicacoes.*') ? 'text-primary-400' : '' }}"><span class="text-slate-600 mr-1">223</span> Controle de Indicacoes</a>
                        ...
                        <a href="{{ route('geral.aniversariantes.index') }}" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700 {{ request()->routeIs('geral.aniversariantes.*') ? 'text-primary-400' : '' }}"><span class="text-slate-600 mr-1">164</span> Aniversariantes</a>
                    </div>
                </div>
