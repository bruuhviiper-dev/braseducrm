            ...
            <nav class="flex-1 overflow-y-auto scrollbar-thin py-1">
                ...
                <div x-data="{ open: activeModule === 'academico' }">
                    ...
                    <div x-show="open && sidebarOpen" x-cloak x-collapse class="bg-slate-800/50">
                        ...
                        <a href="#" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700"><span class="text-slate-600 mr-1">167</span> Config. do Academico</a>
                ...
                <div x-data="{ open: activeModule === 'comunicacao' }">
                    ...
                    <div x-show="open && sidebarOpen" x-cloak x-collapse class="bg-slate-800/50">
                        ...
                        <a href="#" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700"><span class="text-slate-600 mr-1">85</span> Config. Comunicacao</a>
                    </div>
                </div>
                ...
                <div x-data="{ open: activeModule === 'estoque' }">
                    ...
                    <div x-show="open && sidebarOpen" x-cloak x-collapse class="bg-slate-800/50">
                        ...
                        <a href="#" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700"><span class="text-slate-600 mr-1">153</span> Depositos</a>
                ...
                <div x-data="{ open: activeModule === 'financeiro' }">
                    ...
                    <div x-show="open && sidebarOpen" x-cloak x-collapse class="bg-slate-800/50">
                        ...
                        <a href="#" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700"><span class="text-slate-600 mr-1">68</span> Movim. de Caixas</a>
                        <a href="#" class="submenu-item block text-slate-400 hover:text-white hover:bg-slate-700"><span class="text-slate-600 mr-1">111</span> DRE</a>
