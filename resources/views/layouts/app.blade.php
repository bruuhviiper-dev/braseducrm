    ...
    <div class="flex min-h-screen">
        ...
        <aside class="fixed top-0 left-0 z-40 h-screen bg-[#0d0f12] text-gray-300 flex flex-col w-28">
            ...
            <nav class="flex-1 overflow-y-auto scrollbar-thin py-1">
                ...
                {{-- INTEGRACOES --}}
                <a href="{{ route('integracoes.index') }}" class="w-[calc(100%-16px)] mx-2 my-0.5 rounded-xl flex flex-col items-center justify-center gap-1.5 py-2.5 text-[10px] leading-tight transition-colors hover:bg-white/10 {{ request()->is('integracoes*') ? 'bg-gray-200 text-gray-900' : 'text-gray-600' }}">
