    ...
    <table class="w-full text-sm text-left">
        ...
        <tbody class="divide-y">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3">
                    <x-kebab :edit="route('documentos.edit', $d)" :delete="route('documentos.destroy', $d)" />
                </td>
            </tr>
            @empty
            <tr><td colspan="7" class="px-4 py-8 text-center text-gray-400">Nenhum documento cadastrado.</td></tr>
            @endforelse
        </tbody>
    </table>
