        ...
        <table class="w-full text-sm text-left">
            ...
            <tbody class="divide-y">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3">
                        <x-kebab :edit="route('ged.diplomas.edit', $d)" :delete="route('ged.diplomas.destroy', $d)" />
                    </td>
                </tr>
                @empty
                <tr><td colspan="7" class="px-4 py-8 text-center text-gray-400">Nenhum diploma encontrado.</td></tr>
                @endforelse
            </tbody>
        </table>
