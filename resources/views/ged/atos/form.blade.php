    ...
    <div class="bg-white rounded-lg shadow-sm border">
        ...
        <form method="POST" action="{{ isset($ato) ? route('ged.atos.update', $ato) : route('ged.atos.store') }}" class="p-6 space-y-4">
            ...
            <div class="flex gap-3 pt-2">
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700">{{ isset($ato) ? 'Salvar Alteracoes' : 'Cadastrar' }}</button>
